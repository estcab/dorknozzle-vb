...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="AddressGridViewUpdatePanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="employeeDetails" EventName="ItemInserted" />
